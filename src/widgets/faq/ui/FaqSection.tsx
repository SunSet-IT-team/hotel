...
const FAQ_STUBS: FaqItem[] = [
	{
		...
		answer:
			'Заглушка: краткое описание работы сервиса. Здесь позже появится подробный ответ.',
	},
	{
		id: 'q2',
		question: 'Можно ли забронировать отель?',
		answer:
			'Заглушка: да, но детали и ограничения будут добавлены позже ответственным редактором.',
	},
	{
		id: 'q3',
	...
	},
	{
		...
		answer:
			'Заглушка: это условная классификация удобств. Точная расшифровка будет позже.',
	},
	{
		id: 'q5',
		question: 'Куда сейчас стоит поехать?',
		answer:
			'Заглушка: подборка направлений готовится редакцией. Информация обновится в ближайшее время.',
	},
	{
		id: 'q6',
		question: 'Как найти хороший отель?',
		answer:
			'Заглушка: обращайте внимание на рейтинг и отзывы. Подробности появятся позже.',
	},
]
