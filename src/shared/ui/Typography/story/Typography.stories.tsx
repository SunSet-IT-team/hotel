...
export const Default: Story = {
    ...
    <div className={styles.container}>
        ...
        <div className={styles.colorsContainer}>
          ...
          <div className={styles.colorBackground}>
            <Typography color="white">
              Текст поверх цветного фона (white)
            </Typography>
          </div>
        </div>
      </section>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.alignmentsContainer}>
          ...
          <Typography align="justify">
            Justify выравнивание: Lorem ipsum dolor sit amet, consectetur
            adipiscing elit. Curabitur viverra.
          </Typography>
        </div>
      </section>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.truncateContainer}>
          <Typography truncate>
            Очень длинный текст, который не помещается в одну строку и должен
            обрезаться троеточием
          </Typography>
        </div>
      </section>
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Демонстрация различных вариантов использования компонента Typography с разными пропсами.",
      },
    },
  },
};
...
export const Interactive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Интерактивный пример компонента Typography. Используйте панель Controls для изменения пропсов и наблюдения за изменениями в реальном времени.",
      },
    },
  },
};
