...
const meta: Meta<typeof Typography> = {
  ...
  parameters: { 
    ...
    docs: {
      description: {
        component: 'Универсальный типографический компонент для текста с настраиваемыми стилями, цветами и выравниванием.'
      }
    }
  },
  argTypes: {
    ...
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.alignmentsContainer}>
          ...
          <Typography align="justify">
            Justify выравнивание: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur viverra.
          </Typography>
        </div>
      </section>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.tagsGrid}>
          <Typography as="h1" variant="h1" color="blue">H1 тег</Typography>
          <Typography as="p" variant="p">P тег</Typography>
          <Typography as="span" variant="span" color="blue">Span тег</Typography>
          <Typography as="h6" variant="p" color="dark">H6 тег</Typography>
        </div>
      </section>
    </div>
  ),
...
export const Interactive: Story = {
  args: {
    ...
    color: 'dark',
    truncate: false,
    children: 'Это интерактивный пример Typography. Измените пропсы в панели Controls, чтобы увидеть, как меняется компонент.',
  },
  parameters: {
    docs: {
      description: {
